...
public class World {
	 ...
	 public Domain getWinterfell6(){
		 return (Domain) this.get(2,6);
	 }
	 public Domain getTheEyrie4(){
		 return (Domain) this.get(2,4);
	 }
	 ...
	 public void generate(){
		 ...
		 assignFreeDomain(8, 4, 4, 2, "Pentos");
	     ...
	     this.assignDomainWithHouse(3, 4, 2, 2, "They Eyrie", arryn);
	     ...
	     this.assignDomainWithHouse(3, 6, 2, 2, "King Landing", baratheon);
	 ...
	 boolean allowMove(Tile initial, Tile destination, boolean boat){
		 return false;
	 }
